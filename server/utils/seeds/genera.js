...
[
    ...
    {
      "name": "Elephant Ear",
      "description": "Elephant's ears are stunning houseplants. They often feature dark, shield-shaped foliage that may be accentuated by white veins running throughout the leaves. The plants will flower occasionally, sending up a spike with a calla-like white, light yellow, or cream bloom, but the foliage is the reason the plant is grown. Elephant's ear is the perfect plant for high-humidity areas such as bathrooms and kitchens.",
      "instructions": "Elephant's ear grows best in bright light. Too much direct sun, especially in hot-summer climates, can burn the leaves, so these exotic indoor plants benefit from the protection of a sheer curtain from the window. Being true tropicals, they love humidity, so boost moisture levels in the air if it's especially dry. Water as needed, when the top inch or two of the soil dries to the touch. \n\nFertilize elephant's ear a couple of times a year to keep it healthy. The best seasons are spring and summer. Use any fertilizer formulated for use on houseplants.",
      "luxLevel": "High",
      "waterLevel": "Medium",
